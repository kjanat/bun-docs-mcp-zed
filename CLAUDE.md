# github: https://github.com/kjanat/bun-mcp-zed.git

**Final Structure**

```sh
bun-mcp-zed/
├── extension.toml   # Registers [context_servers.bun-docs]
...
# Install in Zed
# Extensions → Install Dev Extension → select bun-mcp-zed/
```
...
4. Add submodule: git submodule add https://github.com/YOU/bun-mcp-zed extensions/bun-mcp-zed
5. Update extensions.toml:

   ```toml
   [bun-mcp-zed]
   submodule = "extensions/bun-mcp-zed"
   version = "0.0.1"
   ```
...
<details>
	<summary>Zed - Developing Extensions</summary>
...
<details>
<summary>Zed - MCP Server Extensions</summary>
